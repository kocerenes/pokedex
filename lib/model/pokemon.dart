...
//
//     final pokedexx = pokedexxFromJson(jsonString);

import 'dart:convert';

Pokedexx pokedexxFromJson(String str) => Pokedexx.fromJson(json.decode(str));

String pokedexxToJson(Pokedexx data) => json.encode(data.toJson());
...
class Pokedexx {
  ...
  factory Pokedexx.fromJson(Map<String, dynamic> json) => Pokedexx(
